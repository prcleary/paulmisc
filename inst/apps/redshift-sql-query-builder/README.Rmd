...
The goal of redshift-sql-query-builder is to simplify creation of SQL queries for Amazon Redshift.

It was completely vibe coded with Claude Opus 4.5 and has undergone limited testing.
...
3. **WHERE Conditions**
   ...
   - Multiple operators: =, !=, >, <, >=, <=, LIKE, ILIKE, IN, NOT IN, IS NULL, IS NOT NULL, BETWEEN

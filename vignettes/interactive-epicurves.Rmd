...
**Note:** The `layout(annotations = ...)` approach adds text labels directly in plotly after conversion, giving you full control over interactive annotation placement.

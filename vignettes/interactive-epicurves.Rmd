...
Add context to your epidemic curves with annotations. **Note:** Annotations are visible in the static ggplot but may not appear in the interactive plotly conversion. For fully interactive timelines, consider adding vertical lines as geoms instead:

```{r annotations-static, message=FALSE, warning=FALSE, eval=FALSE}

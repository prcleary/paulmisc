---
title: "Realistic and corner-case epicurves"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Realistic and corner-case epicurves}
...
The default `simulate_outbreak()` injects a small proportion of missing
values. `epicurve_footnote()` summarises this and stamps the chart with
the run time:

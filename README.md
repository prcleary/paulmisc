...
`2.5` or `7.5` is misleading. `scale_y_epicurve()` is a thin wrapper
around
[`ggplot2::scale_y_continuous()`](https://ggplot2.tidyverse.org/reference/scale_continuous.html)
that:

- forces axis breaks to non-negative integers;
- uses `pretty()` to pick visually sensible intervals;
- accepts any other `scale_y_continuous()` argument (`limits`, `name`,
  `expand`, …).
...
<img src="man/figures/README-scale-y-epicurve-1.png" alt="" width="100%" />

If you want fractional ticks (e.g. to compare against a rate), use the
standard `scale_y_continuous()` instead.
...
<img src="man/figures/README-footnote-1.png" alt="" width="100%" />

### Realistic line list with missing data

`simulate_outbreak()` injects a small proportion of missing values into
the demographic and onset columns by default, mirroring what real
notification systems look like. You can tune the level with
`prop_missing`:
...
<img src="man/figures/README-missing-realistic-1.png" alt="" width="100%" />
...
<img src="man/figures/README-complex-example-1.png" alt="" width="100%" />
